...
module e203_ifu(
  output[`E203_PC_SIZE-1:0]    inspect_pc,//取指的pc
  output                       ifu_active,
  input                        itcm_nohold,
  ...
  //    * Bus cmd channel
  //输出总线接到e203_ifu_ila_en模块//内部直接到ITCM读取指令
...
//---------------------------------------------------
`ifdef e203_ifu_ila_en
  ila_256_1024 e203_ifu_ila (
	.clk(clk), // input wire clk

	.probe0(
          {
                ifu2itcm_icb_cmd_valid, //输出总线接到e203_ifu_ila_en模块//内部直接到ITCM读取指令
                ifu2itcm_icb_cmd_ready, 
                ifu2itcm_icb_cmd_addr,  //16
                ifu2itcm_icb_rsp_valid, 
                ifu2itcm_icb_rsp_ready, 
                ifu2itcm_icb_rsp_err,   
                ifu2itcm_icb_rsp_rdata, //64



                ifu2biu_icb_cmd_valid, //输出总线接到 e203_biu模块 //通过BIU总线读取指令
                ifu2biu_icb_cmd_ready, 
                ifu2biu_icb_cmd_addr, //16 

                ifu2biu_icb_rsp_valid, 
                ifu2biu_icb_rsp_ready, 
                ifu2biu_icb_rsp_err,   
                ifu2biu_icb_rsp_rdata, //32
