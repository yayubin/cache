...
module e203_subsys_mems(
  ...
  input  [`E203_XLEN-1:0]        sysmem_icb_rsp_rdata,
    ...
    //////////////////////////////////////////////////////////
  //输出总线，接到 e203_subsys_perips 中的sirv_flash_qspi_top模块-----------------
...
//-----------------------------------------------------
`ifdef e203_subsys_mems_ila_en
  //ila_1024_1024 e203_subsys_mems_ila (
    ila_512_1024 e203_subsys_mems_ila (
	.clk(clk), 
  .probe0(
            {
              mem_icb_cmd_valid,
